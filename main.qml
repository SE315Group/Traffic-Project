...
Window {
    ...
    MouseArea {
        ...
        onPressed:{
           ...
           toCallRoad.getPointsFromPaintMouseArea(paintCanvas.firstX,paintCanvas.firstY)
            secondPressed = true
            //toCallRoad.
            }
                ...
                toCallRoad.getPointsFromPaintMouseArea(paintCanvas.lastX,paintCanvas.lastY)
